...
ASSETS_PATH = OUTPUT_PATH / Path(r"F:\Projects\Calculator\build\assets\frame0")
...
def on_entry_change(*args):
    max_length = 20  # Maximum number of characters allowed
    current_text = entry_var.get()
    if len(current_text) > max_length:
        entry_var.set(current_text[:max_length]) 
...
def calc_sqaure():
    try:
        ...
        result = num ** 2  # Calculate the square directly
...
# Create a StringVar to store the entry content
entry_var = StringVar()

# Trace changes to the entry field and call on_entry_change function
...
entry = Entry(
    ...
    font=('Arial', 40),
    justify="right",
    width=40,  # Set the visible width of the entry field
